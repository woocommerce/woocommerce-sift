 ...
 */
class Verification_Status extends Sift_Property {

	private Payment_Gateway $gateway;

	protected array $valid_sift_strings = array(
		'$success',
		'$failure',
		'$pending',
	);
	 ...
	 */
	public function __construct( Payment_Gateway $gateway, string $verification_status ) {
